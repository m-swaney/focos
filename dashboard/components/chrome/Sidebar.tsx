  ...
  return (
    <aside className="sticky top-0 hidden h-dvh w-[220px] shrink-0 flex-col border-r border-hairline bg-page px-4 py-5 lg:flex">
      <Link href="/" className="mb-6 flex flex-col gap-1">
        ...
        <span className="truncate text-center text-[10px] font-medium tracking-[0.02em] text-muted" title={label ?? "Family Office Chief of Staff"}>
          {label ?? "Family Office Chief of Staff"}
        </span>
      </Link>
      <NavLinks />
